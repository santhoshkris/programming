...
def get_wormly_downtimes(hostids):
        ...
        if main_sel == 0:
            ...
            while not wormly_menu_back:
                ...
                if wormly_sel == 0:
                    ...
                    on = input("Type in Date (YYYY-MM-DD) [ OR Press Enter to return back to Menu ] : \n")
                    if on == "":
                        continue
                    start = input("Type in Start time [ OR Press Enter to return back to Menu ] : \n")
                    if start == "":
                        continue
                    end = input("Type in Start time [ OR Press Enter to return back to Menu ] : \n")
                    if end == "":
                        continue
                    timezone = input("Type in TimeZone [ OR Press Enter to return back to Menu ] : \n")
                    if timezone == "":
                        continue
